...
class ValidateParamBuilder
{
	...
	*/
	public function addWithRegEx(string $aInputStr, string $aRegExpStr, $aIsInclude = true)
	{
	...
	*@param {boolean} $checkAsUtf8 メールアドレスを utf8 としてチェックするかどうかのフラグ
	*/
	public function addMail(string $mayBeMail, $checkAsUtf8 = true)
	{
	...
	*@param {boolean} $aIsInclude 数値が引数の間か、そうでないかのフラグ。false の時は範囲外チェック
	*/
	public function addBetweenInt(string $aValue1, $aValue2 = null, $aValue3 = null, $aIsInclude = true)
	{
